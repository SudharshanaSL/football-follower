...
?>
	...
	<div class="well"><h2 style="text-align: center;font-size: 50px;font-family: Times; padding:10px;background-color:rgba(5,5,5,.9);color: grey"> Latest Tweets From ManchesterCity FC</h2></div>
    ...
    <script type="text/javascript">
        ...
        function readythis(){
            ...
            xhr.open("GET","bq_ManCity.txt",false)
